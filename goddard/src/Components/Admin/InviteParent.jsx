...
const InviteParent = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 mb-5">
      ...
      <div className="container mx-auto pt-4 sm:pt-6 px-2 sm:px-4 lg:px-8 pb-5 space-y-4 sm:space-y-6">
        {/* Page Header */}
        <div className="flex flex-col gap-3 sm:gap-4">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900">Send Parent Invitation</h1>
          </div>
          <p className="text-sm sm:text-base text-gray-600">Invite a new parent to join the enrollment system</p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
          <Card>
            <CardContent className="p-3 sm:p-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs sm:text-sm font-medium text-gray-600">Step 1</p>
                  <p className="text-sm sm:text-lg font-semibold text-blue-600">Child Information</p>
                </div>
          ...
          <Card>
            <CardContent className="p-3 sm:p-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs sm:text-sm font-medium text-gray-600">Step 2</p>
                  <p className="text-sm sm:text-lg font-semibold text-green-600">Parent Details</p>
                </div>
          ...
          <Card>
            <CardContent className="p-3 sm:p-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs sm:text-sm font-medium text-gray-600">Step 3</p>
                  <p className="text-sm sm:text-lg font-semibold text-purple-600">Send Invitation</p>
                </div>
        ...
        <Card className="w-full max-w-4xl mx-auto">
          <CardHeader>
            <CardTitle className="flex items-center gap-2 text-lg sm:text-xl">
              <Mail className="w-5 h-5 sm:w-6 sm:h-6 text-[#002e4d]" />
