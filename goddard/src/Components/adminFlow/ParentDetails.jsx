    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto pt-6 px-4 sm:px-6 lg:px-8 space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <h1 className="text-3xl font-bold text-foreground">Parent Details</h1>
            <p className="text-muted-foreground mt-1">Manage parent information and invitations</p>
          </div>
          <Button onClick={() => navigate('/invite-parent')} className="bg-primary hover:bg-primary/90">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <Card className="shadow-md">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-muted-foreground">Signed Parents</p>
                      ...
                      <TableRow key={index}>
                        <TableCell>
                          {row.primary_email ? (
                            ...
                            <span className="text-foreground">{row.parent_name}</span>
                          )}
                        </TableCell>
                        ...
                        <TableCell>
                          <div className="flex gap-2">
                            <Button
                              ...
                              className={row.invite_status === 'Active' ? "" : "bg-primary hover:bg-primary/90"}
                            >
                            ...
                            <Button
                              ...
                              className={row.invite_status === 'Inactive' ? "" : "bg-primary hover:bg-primary/90"}
                            >
